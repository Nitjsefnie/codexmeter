...
function backendDashToShape(b) {
  ...
  return {
    events, tokenTypes, limitHits, range, costByModel,
...
function dashboardBinMs(range, bucketS) {
  // Auto-pick the largest nice bin that still yields at least 100 display
  // bins over the visible data, then respect any coarser server aggregate.
