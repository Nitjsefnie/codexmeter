...
#
# A Claude Code session reaches the Codex bucket whenever claude-code-proxy
# routes one through Codex: archive_sessions.py picks the bucket from the
# provider marker in the transcript, so the bytes are Claude's, not Codex's.
